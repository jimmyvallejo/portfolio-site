...
const Intro = () => {
  ...
  if(isWide){
    text = `I'm a full-stack developer with a focus on building dynamic and
    ...
    text = `I'm a full-stack developer with a 
    focus on building dynamic and scalable applications. My goal is to make 
    intuitive solutions to real world 
    problems through my design,and my code. 
    Currently employed at Cryptan Labs.`;
  }
